...
<ViewSource href="https://github.com/ELDment/swiftlys2/blob/fix-loop/managed/src/SwiftlyS2.Shared/Modules/Events/EventDelegates.cs#L90" />
...
- <ApiParam name="event" type="IOnClientProcessUsercmdsEvent" typeHref="/docs/api/shared/events/ionclientprocessusercmdsevent" />
