...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L8)
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L26)

Creates an instance of <xref href="SwiftlyS2.Core.Menus.OptionsBase.SubmenuMenuOption" data-throw-if-not-resolved="false"></xref> with a pre-built submenu.
...
- **submenu**: [IMenuAPI](/docs/api/menus/imenuapi) - The submenu to open when this option is clicked.
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L43)
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L61)

Creates an instance of <xref href="SwiftlyS2.Core.Menus.OptionsBase.SubmenuMenuOption" data-throw-if-not-resolved="false"></xref> with a synchronous builder.
...
- **submenuBuilder**: [Func](https://learn.microsoft.com/dotnet/api/system.func-1)<[IMenuAPI](/docs/api/menus/imenuapi)> - Function that builds and returns the submenu.
- **updateIntervalMs**: [int](https://learn.microsoft.com/dotnet/api/system.int32) - The interval in milliseconds between text updates. Defaults to 120ms.
- **pauseIntervalMs**: [int](https://learn.microsoft.com/dotnet/api/system.int32) - The pause duration in milliseconds before starting the next text update cycle. Defaults to 1000ms.
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L78)
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L96)

Creates an instance of <xref href="SwiftlyS2.Core.Menus.OptionsBase.SubmenuMenuOption" data-throw-if-not-resolved="false"></xref> with an asynchronous builder.
...
- **submenuBuilderAsync**: [Func](https://learn.microsoft.com/dotnet/api/system.func-1)<[Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1)<[IMenuAPI](/docs/api/menus/imenuapi)>> - Async function that builds and returns the submenu.
- **updateIntervalMs**: [int](https://learn.microsoft.com/dotnet/api/system.int32) - The interval in milliseconds between text updates. Defaults to 120ms.
- **pauseIntervalMs**: [int](https://learn.microsoft.com/dotnet/api/system.int32) - The pause duration in milliseconds before starting the next text update cycle. Defaults to 1000ms.
...
[View Source](https://github.com/swiftly-solution/swiftlys2/blob/master/managed/src/SwiftlyS2.Core/Modules/Menus/OptionsBase/SubmenuMenuOption.cs#L113)
