...
- <ApiParam name="choice" type="string" typeHref="https://learn.microsoft.com/dotnet/api/system.string" /> — The choice to select. Must exist in the <xref href="SwiftlyS2.Core.Menus.OptionsBase.ChoiceMenuOption.Choices" data-throw-if-not-resolved="false"></xref> list.
