...
See [IMemoryService](/docs/api/memory/imemoryservice/).

See [IUnmanagedFunction](/docs/api/memory/iunmanagedfunctiont/).

See [IUnmanagedMemory](/docs/api/memory/iunmanagedmemory/).

See [Library](/docs/api/memory/library/).