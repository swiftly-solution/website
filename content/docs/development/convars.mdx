...
See [ConvarFlags](/docs/api/shared/convars/convarflags/).

See [IConVar](/docs/api/shared/convars/iconvar/).

See [IConVarService](/docs/api/shared/convars/iconvarservice/).
